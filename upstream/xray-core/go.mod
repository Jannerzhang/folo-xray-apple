...
// The first-release module graph uses the split genproto modules. Excluding
// this legacy aggregate version prevents an unrelated QUIC qlog test graph
// from providing duplicate package paths during the mobile build.
