...
func getControlFunc(ctx context.Context, sockopt *SocketConfig, controllers []ControlFunc) func(network, address string, c syscall.RawConn) error {
...
//
// xray:api:beta
func RegisterListenerController(controller ControlFunc) error {
	if controller == nil {
