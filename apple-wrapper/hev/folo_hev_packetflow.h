 ...
 * caller retains ownership of the supplied descriptor while this call is
 * in progress; the wrapper adopts an internal dup only after validation. No
 * tunnel descriptor is opened or discovered by this API. The configuration
 * is a bounded Hev evaluation profile whose SOCKS5 endpoint must be supplied
 * by the caller.
 */
